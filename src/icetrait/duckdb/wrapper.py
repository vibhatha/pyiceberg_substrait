...
class DuckdbSubstrait:
    ...
    def update_with_local_file_paths(self):
        ...
        update_visitor = RelUpdateVisitor(files=self._files, formats=self._formats, base_schema=base_schema, current_schema=current_schema, output_names=output_names)
